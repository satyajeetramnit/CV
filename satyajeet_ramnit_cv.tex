...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        % \resumeItem{}{Collaborated with cross-functional teams, following \textbf{Agile} methodology, and \textbf{Developed} an automated \textbf{pipeline}, using \textbf{Docker, CI/CD, Jenkins, Python} to analyze AIRx performance on-site data.}
        \resumeItem{}{Developed an \textbf{automated pipeline} using modern technologies like \textbf{Docker}, \textbf{Docker-Compose}, \textbf{Gradle}, \textbf{Python}, \textbf{Java}, \textbf{Linux}, \textbf{CI/CD}, and \textbf{Jenkins}.}
        % \resumeItem{}{Resulted in a \textbf{reduction} of crucial \textbf{time spent} on debugging and setup \textbf{by 15 - 20 hr/week}.}
        \resumeItem{}{Achieved significant \textbf{productivity} and \textbf{efficiency} improvements by \textbf{reducing} the debugging \textbf{time} by approximately \textbf{132x} due to \textbf{automation}. i.e., [  $ \approx \textbf{33 hrs.}$ workflow reduced to $ \approx \textbf{15 mins}$}]
        ...
        \resumeItem{}{\textbf{Designed} the \textbf{pipeline} to be \textbf{accessible} to anyone \textbf{without prior knowledge} of \textbf{AIRx}, \textbf{identifying issues} quickly, and \textbf{providing statistics} to optimize the algorithm and \textbf{improve} its \textbf{accuracy}.}
        ...
        \resumeItem{}{Enabled \textbf{developers} to \textbf{better utilize} their \textbf{time} and be more \textbf{productive}, leading to \textbf{improved workflow} and project success.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{}{Gained \textbf{hands-on} experience in \textbf{Flutter, JavaScript, EDA Tools, and Linux} through training and mentorship.}
        \resumeItem{}{Developed \textbf{baseline knowledge} of software, applications, and technical processes within creating mobile applications, and website functionality using \textbf{Flutter} and \textbf{JavaScript}.}
...
\section{Projects}
  \resumeSubHeadingListStart
     \resumeSubheading{\href{https://www.codedynamics.in/}{Code Dynamics}}{{\href{https://github.com/AnkitRajCode/CodeDynamics}{\bf - Source Code}}}{A platform offering optimized solutions for various programming languages.}{}
      \resumeItemListStart
        % \resumeItem{}{Developed Code Dynamics, a \textbf{platform} that offers \textbf{optimized} DSA \textbf{solutions} for all major platforms, with \textbf{30,000+ solutions}, \textbf{50+ Rapid Revision Sheet}, and \textbf{Dynamics sheet} in various languages.}
